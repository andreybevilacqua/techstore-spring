...
public final class DBInitializer {
    ...
    public static ApplicationRunner initializeDB(ProductRepo productRepo) {
        return args -> Stream.of(
                new Product(1, "Mouse", "Really good mouse", 20, 1),
                new Product(2, "Notebook", "Great notebook", 1000, 1),
                new Product(3, "Keyboard", "Great keyboard", 300, 1),
                new Product(4, "Headphones", "Great headphones", 60, 1),
                new Product(5, "Touchscreen", "Great screen", 500, 1))
